    ...
    <section className="relative min-h-[70vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 py-8">
        <div className="max-w-3xl text-white">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-3 leading-[1.1] tracking-tight">
          ...
          <h2 className="text-base md:text-lg text-slate-200 mb-6 leading-relaxed font-light">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-3">
            <a 
              ...
              className="bg-[#25D366] hover:bg-[#20bd5a] text-white px-6 py-3 rounded-xl font-bold text-center transition-all transform hover:scale-105 flex items-center justify-center space-x-2 shadow-xl shadow-green-900/30 text-sm"
            >
            ...
            <a 
              href="#servicos" 
              className="bg-white/10 backdrop-blur-md hover:bg-white/20 text-white border border-white/30 px-6 py-3 rounded-xl font-bold text-center transition-all flex items-center justify-center space-x-2 text-sm"
            >
          ...
          <p className="text-xs text-slate-300 italic mb-8 flex items-center gap-2">
            <CheckCircle2 className="w-3 h-3 text-[#25D366]" />
            Orçamento rápido e sem compromisso pelo WhatsApp
          </p>

          <div className="mt-6 border-t border-white/10 pt-6">
            <p className="text-xs font-bold text-[#FF8C00] uppercase tracking-wider mb-4">Nossos Principais Serviços</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={idx} className="flex items-center space-x-2">
                  ...
                  <span className="text-xs font-medium text-slate-100">{service}</span>
                </div>
              ))}
            </div>
          </div>
