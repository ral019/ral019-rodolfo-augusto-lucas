...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#000d1a] text-white pt-12 pb-8">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10 pb-10 border-b border-white/10">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-white text-lg font-black tracking-tight leading-none uppercase">CASA DOS VIDROS</span>
                <span className="text-[#FF8C00] text-[8px] font-bold tracking-[0.2em] uppercase mt-1">Vidraçaria e Esquadrias<br/>em Alumínio Limeira</span>
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              <a 
                ...
                className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-[#FF8C00] transition-all hover:scale-110"
          ...
          <div>
            <h4 className="font-bold text-base mb-4 text-[#FF8C00]">Navegação</h4>
          ...
          <div>
            <h4 className="font-bold text-base mb-4 text-[#FF8C00]">Contato Direto</h4>
          ...
          <div>
            <h4 className="font-bold text-base mb-4 text-[#FF8C00]">Solicite Orçamento</h4>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-slate-500 text-[9px] md:text-[10px]">
